...
namespace OPS_API.Class
{
   ...
   public string itemcode { get; set; }
        ...
        public resultsrtrClass(string item_code, string Lot_nosf, string lot_no, string sublot_no, double no_bags, string lab_name, string area_code, string farmer_name, string sam_results, string preu_results, string prepa_results, string toxineu_results, string toxinepa_results, double heat_value, string buy_rej)
        {
            itemcode = item_code;
            Lotnosf = Lot_nosf;
            lotno = lot_no;
