...
{
    public class bitriplistrtrClass
    {
        ...
        public bitriplistrtrClass(string trip_no, string from_location, string to_location, string pr_no, string tyre_details, string operator_name, double freight_value, double handling_value, DateTime trip_date, string lorry_no, double no_bags, string lot_no, DateTime avt_in, DateTime avt_out, DateTime trip_in, double other_values, double cess_amt, string amc_no, DateTime amc_date)
