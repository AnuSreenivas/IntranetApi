...
{
    public class orderbookcustprdClass
    {
        ...
        public orderbookcustprdClass(string cust_name,string base_prd, double _month1, double _month2, double _month3, double _month4, double _month5, double _month6, double _month7, double _month8, double _month9, double _month10, double _month11, double _month12, double total_orders)
        {
            custname = cust_name;
            baseprd = base_prd;
            month1 = _month1;
