...
{
    public class orderbookcustClass
    {
       public string custname { get; set; }
        ...
        public orderbookcustClass(string cust_name, double _month1, double _month2, double _month3, double _month4, double _month5, double _month6, double _month7, double _month8, double _month9, double _month10, double _month11, double _month12, double total_orders)
        {
            custname = cust_name;
            month1 = _month1;
            month2 = _month2;
