...
namespace OPS_API.Class
{
    public class bitoxinrtrClass
    {
        ...
        public bitoxinrtrClass(string lot_no, double Afla_B1, double Afla_toxin, double ochra_toxin, string eu_res, string epa_res, string ochraeu_res, string ochraepa_res)
        {
            lotno = lot_no;
           AflaB1 = Afla_B1;
