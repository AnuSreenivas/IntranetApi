...
//   public string invrefno { get; set; }
   ...
   public double sgstamount { get; set; }
        ...
        //eway bill
   public getinvdtlsClass(string self_gstin, string system_code, string branch_code, string vertical_code, string irn_genreg, string tran_catg, string reverse_charge, string transaction_mode, string igst_onintra, string exp_categ, string exp_payment, string sb_no, DateTime sb_date, string port_code, double inv_amount, string for_curr, string country_code, string ref_clm, double exp_duty, string doc_type, string doc_no, DateTime doc_date, string supplier_gstin, string supplier_name, string supplier_tradename, string supplier_loc, string supplier_pin, string supplier_state, string buyer_gstin, string buyer_name, string buyer_tradename, string buyer_loc, string buyer_pin, string buyer_state, string buyer_pos, string dispatch_gstin, string dispatch_name, string dispatch_tradename, string dispatch_loc, string dispatch_pin, string dispatch_state, string ship_gstin, string ship_name, string ship_tradename, string ship_loc, string ship_pin, string ship_state, string item_name, string item_hsn, double item_qty, string item_uom, double item_rate, double gross_value, double ass_amt, string tax_ability, double cgst_rate, double cgst_amount,double  sgst_rate,
            double  sgst_amount,
            double  igst_rate,
            double  igst_amount,
            double  cess_rate,
